...
using EPayDomain.Repository;

namespace EPayProcessorGateway
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "EPayProcessorGateway", Version = "v1" });
            });
            ...
            services.AddScoped<IRoutePaymentGateway, RoutePaymentGateway>();

            //Comment these because they are not to be injected
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "EPayProcessorGateway v1"));
            }
